...
void updateLog() {
	...
	fprintf(logfp, "**************************\n");
	fprintf(logfp, "SCALE			: %ld\n", SCALE);
	fprintf(logfp, "TotVertices		: %ld\n", \
			TotVertices);
	fprintf(logfp, "MaxCliqueSize		: %ld\n", \
			MaxCliqueSize);
	fprintf(logfp, "ProbUnidirectional	: %lf\n", \
			ProbUnidirectional);	
	fprintf(logfp, "ProbIntercliqueEdges	: %lf\n", \
			ProbIntercliqueEdges);
	fprintf(logfp, "MaxParallelEdges	: %ld\n", \
			MaxParallelEdges);
	fprintf(logfp, "MaxWeight		: %ld\n", \
			MaxWeight);
	fprintf(logfp, "MinWeight		: %ld\n", \
			MinWeight);
